...
import sys
from algos.BaseSearchFrontier import SearchFrontier


class AnchorSearch(SearchFrontier):
    """
    Implements the Anchor Search algorithm for bidirectional search in Sokoban.
    """
